...
/**
 * Transforma a imagem em padrão de Edge Detection
 *
 * @author Breno Rodrigues, Bruno Novo, Gabriel Odakura
 * @version 20231106
 */
public class EdgeDetection {
    public static BufferedImage edgeDetectionFilter(BufferedImage imagem){
        int width, height;
        int ordem = 3;
            ...
            for (int x = 0; x < width; x++){
                ...
                for(int i = 0; i < ordem; i++){
                    for(int j = 0; j < ordem; j++){
                        ...
                        int matriz = imagem.getRGB(imagemX,imagemY); //pega o RGB do ponto individual da imagem
        ...
        System.out.println("Edge Detection successful!");
        return output;
    }
}
